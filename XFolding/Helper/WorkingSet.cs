...
namespace XGA.Helper {
    ...
    public abstract class WorkingSet<T, C>
        ...
        protected WorkingSet(string Name, GeneticAlgorithmConfig<T> GAC, IGeneticOperatorProvider<T> Provider, Func<GeneticAlgorithm<T>, C> CM) {
            ...
            this.GA = new GeneticAlgorithm<T>(GAC, Provider, Log);
